...
namespace BullsAndCows
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(pcNumber);                                      //числото на компютъра
            ...
            //Console.WriteLine($"{cgOne} + {cgTwo} + {cgThree} + {cgFour}");   // коментар-проверка
            while (true)
            {
                Console.Write("Enter number (4 digits): ");                     //бъгва, ако се въведе буква
